Webruntime.moduleRegistry.define('webruntimegenerated/view__preview', ['lwc', 'lightning/breadcrumbs', 'lightning/breadcrumb', 'lightning/spinner', 'webruntime/componentService'], function (lwc, _lightningBreadcrumbs, _lightningBreadcrumb, _lightningSpinner, componentService) { 'use strict';

    _lightningBreadcrumbs = _lightningBreadcrumbs && _lightningBreadcrumbs.hasOwnProperty('default') ? _lightningBreadcrumbs['default'] : _lightningBreadcrumbs;
    _lightningBreadcrumb = _lightningBreadcrumb && _lightningBreadcrumb.hasOwnProperty('default') ? _lightningBreadcrumb['default'] : _lightningBreadcrumb;
    _lightningSpinner = _lightningSpinner && _lightningSpinner.hasOwnProperty('default') ? _lightningSpinner['default'] : _lightningSpinner;
    ...
    var html = lwc.registerTemplate(tmpl$5);
    tmpl$5.stylesheets = [];
